    ...
    <div class="e-calendar">
      <!-- <div class="e-date-select">
        ...
        <div class="e-date-monthday">
          <transition name="fadeY">
            ...
            ><span>{{keepDoubleDigit(selectDate.month)}}-{{keepDoubleDigit(selectDate.day)}}</span> <span>{{selectDate.weekStr}}</span></div>
          </transition>
        </div>
      </div> -->
      <div
      ...
      >
        <div class="e-calendar-toolbar">
          <div
            class="e-calendar-svg"
            @click="prevMonth"
          >
            <!-- <svg
              viewBox="0 0 24 24"
              class="e-calendar-svg-icon"
            >
          ...
          <div class="e-calendar-toolbar-title">
            <transition :name="fadeXType">
              <div
                :key="showDate.monthStr"
                class="e-calendar-toolbar-title-content"
              ><span>{{showDate.year}}年</span> <span>{{ showDate.monthStr }}月</span></div>
            </transition>
          </div>
          <div
            class="e-calendar-svg"
        ...
        <div class="e-calendar-monthday">
          <transition :name="fadeXType">
            <div
              :key="showDate.monthStr"
              class="e-calendar-monthday-wrapper"
            >
              <div
                class="e-calendar-monthday-row"
              ...
              >
                ...
                >
                  <span
                    v-text="day.value"
                    class="e-calendar-monthday-row-day-value"
                  ></span>
                  <transition name="e_calendar_day">
                    <span
                      class="e-calendar-monthday-row-day-cover"
                      v-if="day.selected"
                    ></span>
                  </transition>
                </span>
...
export default {
  ...
  computed: {
    ...
    rows() {
      ...
      this.showDate.monthStr = this.showDate.month
      return result
    }
  },
  data() {
...
@import '~common/stylus/basic';
@import '~common/stylus/borderBox';
